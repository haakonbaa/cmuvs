...
public:
    ...
    Eigen::Matrix4d evalDot(const Eigen::VectorXd& params, const Eigen::VectorXd& diffParams) const;
    Eigen::Matrix4d evalDotVec(const Eigen::VectorXd& params, const Eigen::VectorXd& diffParams) const;
